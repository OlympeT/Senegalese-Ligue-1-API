class ChampionshipsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @championship.save
        format.html { redirect_to championships_path, notice: 'Championship was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @championship.update(championship_params)
        format.html { redirect_to championships_path, notice: 'Championship was successfully updated.' }
  ...
  def championship_params
    params.require(:championship).permit(:beginning, :end_saison)
  end
end
